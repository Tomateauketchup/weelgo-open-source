...
public class CMEvents {
	...
	public static final String GROUP_NAME_MODIFIED = "CM/GROUP_NAME_MODIFIED";
	public static final String GROUP_PACKAGE_NAME_MODIFIED = "CM/GROUP_PACKAGE_NAME_MODIFIED";
	public static final String GROUP_BACKGROUND_COLOR_MODIFIED = "CM/GROUP_BACKGROUND_COLOR_MODIFIED";
	public static final String GROUP_BACKGROUND_VISIBLE_MODIFIED = "CM/GROUP_BACKGROUND_VISIBLE_MODIFIED";
	public static final String GROUP_BORDER_COLOR_MODIFIED = "CM/GROUP_BORDER_COLOR_MODIFIED";
	public static final String GROUP_BORDER_VISIBLE_MODIFIED = "CM/GROUP_BORDER_VISIBLE_MODIFIED";
